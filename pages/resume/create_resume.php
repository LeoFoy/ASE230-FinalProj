...
//$resume=$resume->fetchAll();
    ...
    if (count($_POST)>0){
		query($pdo,'INSERT INTO resume (Name,Phone_Number,Email,Linkedin,Github,Personal_Website,Summary) VALUES(?,?,?,?,?,?,?)',[$_POST['name'],$_POST['phone'],$_POST['email'],$_POST['linkedin'],$_POST['github'],$_POST['website'],$_POST['summary']]);
		query($pdo,'INSERT INTO awards (Award) VALUES(?)',[$_POST['award']]);
		query($pdo,'INSERT INTO education (Graduation_Year,School_Name) VALUES(?,?)',[$_POST['Highschool'],$_POST['Highschoolyears']]);
		query($pdo,'INSERT INTO interests (Interest) VALUES(?)',[$_POST['interest1']]);
		query($pdo,'INSERT INTO languages (Language) VALUES(?)',[$_POST['language']]);
		query($pdo,'INSERT INTO skills (Skill) VALUES(?)',[$_POST['job1Skill1']]);
		query($pdo,'INSERT INTO work_experience (Achievement,Company_Name,Job_Name,Start_Date,Technology_Used) VALUES(?,?,?,?,?)',[$_POST['job1Achieve'],$_POST['job1Company'],$_POST['job1Title'],$_POST['job1Tenure'],$_POST['job1Tech1']]);
