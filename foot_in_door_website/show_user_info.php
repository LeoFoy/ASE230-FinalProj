...
if (isset($_SESSION['username']) && isset($_SESSION['email']) && isset($_SESSION['phone']) && isset($_SESSION['password'])) { ?>
			...
			<header class="bg-dark py-5">
				<div class="container px-4 px-lg-5 my-5">
					<div class="text-center text-white">
						<h1 class="display-6 fw-bolder">Username: <?php echo $_SESSION['username']; ?></h1>
						<h1 class="display-6 fw-bolder">Email: <?php echo $_SESSION['email']; ?></h1>
						<h1 class="display-6 fw-bolder">Phone: <?php echo $_SESSION['phone']; ?></h1>
