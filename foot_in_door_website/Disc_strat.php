        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Interview Strategies</h1><br />
                    <a href="discussion_board/create.php" class="btn btn-primary mb-3">Create Post</a>
                     <?php
					$posts= query($pdo, 'SELECT * FROM users natural join discussion_board WHERE Topic=?',['Interview Strategies']);
